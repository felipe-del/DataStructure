...
#include "linear/ArrayStack.hpp"

inline void testArrayStack() {

    std::cout << "==============================\n";
    std::cout << " TEST ArrayStack<int>\n";
    std::cout << "==============================\n\n";
    ...
    std::cout << "\n==============================\n";
    std::cout << " TEST ArrayStack<std::string>\n";
    std::cout << "==============================\n\n";

    ArrayStack<std::string> strStack;
    ...
    std::cout << "\n==============================\n";
    std::cout << " TEST ArrayStack<Person>\n";
    std::cout << "==============================\n\n";

    ArrayStack<Person> people;
    ...
    // --- Movimiento ---
    ArrayStack<Person> movedPeople = std::move(people);

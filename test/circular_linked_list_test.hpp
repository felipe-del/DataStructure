...
#include "../include/linear/CircularLinkedList.hpp"
...
inline void testCircularLinkedList() {

    std::cout << "==============================\n";
    std::cout << " TEST CircularLinkedList<int>\n";
    std::cout << "==============================\n\n";
    ...
    std::cout << "Modificando valores (*2): ";
    for (auto it = list.begin(); it != list.end(); ++it)
        *it *= 2;
    ...
    std::cout << "\n==============================\n";
    std::cout << " TEST CircularLinkedList<std::string>\n";
    std::cout << "==============================\n\n";
    ...
    std::cout << "\n==============================\n";
    std::cout << " TEST CircularLinkedList<Person>\n";
    std::cout << "==============================\n\n";
    ...
    // --- Movimiento ---
    CircularLinkedList<Person> movedPeople = std::move(people);
    ...
    std::cout << "\n==============================\n";
    std::cout << " FIN TEST CircularLinkedList\n";
    std::cout << "==============================\n";
}